...
class PlayerAI(Player):
    ...
    def make_next_move(self, game):
        ...
        self.letter = good_moves[random_index][3]
        #def change_button_text(self, row, col, text): 
        self.sos_game_ui.ai_button_click(good_moves[random_index][1], good_moves[random_index][2], self.sos_game_ui)
        self.sos_game_ui.rename_board_buttons(good_moves[random_index][1], good_moves[random_index][2], self.sos_game_ui.game.current_player.get_cell_type())
